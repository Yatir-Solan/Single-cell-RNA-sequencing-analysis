...
4. All the code can be examined in the jupyter notebook present (single_cell_analysis.md or single_cell_analysis.ipynb). The reconstructed figures are also given as png files.
